...
const jsonLd = [
  {
    ...
    "@type": "TechArticle",
    headline: "TIFF Format Deep Dive",
    description:
      "Technical guide to TIFF file structure, IFD entries, tag types, and how PicScrub removes metadata while preserving image quality.",
    url: "https://picscrub.com/formats/tiff",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "TIFF", item: "https://picscrub.com/formats/tiff" },
    ],
  },
];
...
export default function TIFFPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <JsonLd id="tiff-schema" data={jsonLd} />
