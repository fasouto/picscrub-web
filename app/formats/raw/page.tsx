...
const jsonLd = [
  {
    ...
    "@type": "TechArticle",
    headline: "RAW Format Deep Dive",
    description:
      "Technical guide to RAW camera formats including DNG, CR2, NEF, and ARW. Learn about TIFF-based structure and metadata removal.",
    url: "https://picscrub.com/formats/raw",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "RAW", item: "https://picscrub.com/formats/raw" },
    ],
  },
];
...
export default function RAWPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <JsonLd id="raw-schema" data={jsonLd} />
